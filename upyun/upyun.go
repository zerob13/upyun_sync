 ...
 */
const EdAuto = "v0.api.upyun.com"

/**
* 电信接入点:v1.api.upyun.com
 */
const EdTelecom = "v1.api.upyun.com"

/**
* 联通网通接入点:v2.api.upyun.com
 */
const EdCnc = "v2.api.upyun.com"

/**
* 移动铁通接入点:v3.api.upyun.com
 */
const EdCtt = "v3.api.upyun.com"
...
return 当前接入点网址
*/
func (u *UpYun) GetApiDomain() (domain string) {
	return u.apiDomain
}
...
*return timeout
 */
func (u *UpYun) GetTimeout() (time int) {
	return u.TimeOut
}
